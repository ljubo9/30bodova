  ...
  useEffect(() => {
    ...
    const fetchDietInfo = async () => {
      try {
        ...
        //i ima dnevni limit
        const response = await fetch(`https://kuhajitbackend.onrender.com/diet/user/${user.username}`);
        if (response.ok) {
          const data = await response.json();
          setDiet(data);
        } else {
    ...
    const fetchFollowedChefs = async () => {
      try {
        ...
        const response = await fetch(`https://kuhajitbackend.onrender.com/followed-enthusiasts/${user.username}`);
        if (response.ok) {
          const data = await response.json();
    ...
    const fetchConsumedRecipesStatistics = async () => {
      try {
        ...
        const response = await fetch(`https://kuhajitbackend.onrender.com/statistic/user/${user.username}`);
        if (response.ok) {
          const data = await response.json();
